...
--) fga 
inner join (select transaction_id, max(view_id) as view_id from tajawal_bi.fact_google_analytics_transactions_final where view_id in ('109503410', '130709589') group by transaction_id) fga
